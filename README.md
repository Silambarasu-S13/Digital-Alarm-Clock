# Digital-Alarm-Clock
The goal of this project is to blow alarm depending on the configuration set by the user (ex: daily / weekly / particular day).

A digital clock built with an alarm system is called as an alarm clock.
